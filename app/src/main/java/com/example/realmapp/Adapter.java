...
public class Adapter extends BaseAdapter {
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        viewHolder.edad.setText(String.valueOf("Edad: "+list.get(pos).getAge()));

        if (list.get(pos).isGender()){
    ...
    private void dialogoEdit(final Contact contact){
        ...
        edad.setText(String.valueOf(contact.getAge()));
        genero.setChecked(!contact.isGender());
        ...
        builder.setPositiveButton("Guardar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (nameStr.length() >0) {
                    ...
                    contact.setAge(edadInt);
                    contact.setGender(sexoBoolean);
